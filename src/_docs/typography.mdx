...
Typography helps establish hierarchy and communicate important content by creating clear visual patterns. We have multiples ways to display text. You can use our `Text` component or our typography helpers. Both of them are linked to our design tokens and could be used responsively.
...
<Source
  dark
  code={`import { Text } from '@mocked-design-system';
...
<Source
  dark
  code={`import { typography } from '@mocked-design-system/';
